      ...
      <div className="m-10 font-bold">
        <div>
          ...
          <div onClick={handleClick} className="text-xl ml-4  ">
            ...
            <div className="flex justify-between bg-slate-200 m-2 p-3 shadow-lg cursor-pointer">
              <p className="hover:opacity-10">Change your Username</p>{" "}
              <p className="mr-5 hover:opacity-10">+</p>
            </div>
            <div className="flex justify-between bg-slate-200 m-2 p-3 shadow-lg cursor-pointer">
          ...
          <div>{show && <PasswordModal closeModal={closeModal} />}</div>
        </div>
        <div>
          ...
          <div className="text-xl ml-4  ">
            ...
            <div className="flex justify-between bg-slate-200 m-2 p-3 shadow-lg cursor-pointer">
              ...
              >
                <div
                  className={
                    theme === "light"
                      ? "w-6 bg-black rounded-3xl"
                      : "w-6 bg-white rounded-3xl "
                  }
                >
                  <button></button>
                </div>
            ...
            <div>{show1 && <LogoutModal closeModal={closeModal1} />}</div>
          </div>
        </div>
      </div>
    </div>
