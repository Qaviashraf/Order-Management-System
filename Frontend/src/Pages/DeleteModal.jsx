...
function DeleteModal({ closedelModal, deleteModal, propsId, onDelete }) {
    ...
    <>
      ...
      <div className='modal-cont w-[50%]'>
        ...
        <div className='flex justify-between py-4'>
          ...
          <button className='rounded p-2 bg-red-500 hover:opacity-40 text-white' onClick={() => onDelete(propsId)} >Delete</button>
        </div>
      </div>
    </>
  )
